      ...
      <CardContent className="p-3">
        ...
        <div className="flex justify-between items-start">
          <div className="flex-grow">
            <h4 className="font-semibold text-base truncate text-gray-950">{lead.nome}</h4>
            {lead.empresa && <span className="text-xs text-gray-500">{lead.empresa}</span>}
          </div>
          
          <div className="flex items-center space-x-1">
            {/* Drag handle - mais visível e melhor feedback */}
            <Button variant="ghost" size="sm" className="h-6 w-6 p-0 cursor-grab active:cursor-grabbing hover:bg-vendah-purple/10 rounded-full" {...attributes} {...listeners}>
