...
const SupabaseSetupGuide: React.FC = () => {
  return (
    <Card className="mb-6">
      <CardHeader>
        <CardTitle className="text-xl font-semibold">Configuração do Supabase</CardTitle>
        <CardDescription>
          Siga estas instruções para configurar corretamente as URLs de redirecionamento no Supabase
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <Alert>
          ...
          <AlertDescription>
            Se você estiver enfrentando problemas com autenticação, provavelmente precisa configurar as URLs de redirecionamento no Supabase.
          </AlertDescription>
        </Alert>

        <div className="space-y-4">
          <h3 className="font-medium">Siga estes passos:</h3>
