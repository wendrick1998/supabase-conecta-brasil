...
export const PreviewDialog: React.FC<PreviewDialogProps> = ({
  ...
  const generateTextFlow = (): React.ReactNode => {
    ...
    return triggerBlocks.map((trigger, index) => (
      <div key={trigger.id} className="mb-6">
            ...
            <div key={connId} className="mt-2">
              <div className="flex items-center mb-1">
                ...
                {connectedBlock.category === 'condition' ? (
                  ...
                  <span className="font-medium text-green-700">Então:</span>
                )}
