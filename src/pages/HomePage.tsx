...
const HomePage = () => {
  ...
  return <div className="min-h-screen bg-bg text-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 pt-12 lg:pt-20 pb-24 relative z-10">
        <nav className="flex justify-between items-center mb-20">
          <div className="flex items-center">
            <img src="/lovable-uploads/3decb854-1aac-4760-b4a6-6dd4e3fc318c.png" alt="Vendah+" className="h-28 md:h-32 animate-subtle-glow" />
          </div>
      ...
      <div id="features" className="bg-surface py-24 relative section-spacing">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <FeatureCard icon={Users} title="Gestão de Leads" description="Organize e acompanhe seus leads de forma eficiente com ferramentas inteligentes" />
            
            <FeatureCard icon={BarChart} title="Pipeline de Vendas" description="Visualize todo o processo de vendas com dashboards interativos e personalizáveis" />
            
            <FeatureCard icon={MessageSquare} title="Conversas Integradas" description="Comunique-se com clientes diretamente pela plataforma sem trocar de ferramenta" />
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
            <FeatureCard icon={Zap} title="Automações" description="Crie fluxos de trabalho automatizados para aumentar a eficiência e diminuir tarefas repetitivas" />
            
            <FeatureCard icon={Shield} title="Segurança Avançada" description="Proteção de dados e conformidade com as regulamentações de privacidade" />
          </div>
        </div>
      </div>
